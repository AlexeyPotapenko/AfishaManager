...
class AfishaManagerTest {
    ...
    @Test
    void shouldShowLastAddedFilmsOverLimit() {
    ...
    @Test
    void shouldShowLastAddedFilmsNoOverLimit() {
        AfishaManager afisha = new AfishaManager(9);
    ...
    @Test
    void shouldShowLastAddedFilmsEqualsLimit() {
